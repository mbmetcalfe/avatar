...
/set psi_asha=pain pain
/set psi_atrocity=atrocity atrocity
...
/set psi_ponomariov=pono pono
/set psi_psychotia=psycho schizo
/set psi_pyriame=dreams dreams
...
/set psi_sorak=amagadon amagadon
